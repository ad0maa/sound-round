...
const NewLeaguePage = () => {
  ...
  return (
    <>
      ...
      <PageHeader title="New League" icon={step === 1 ? Trophy : ListMusic} />
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Give each round a theme. Rounds open one at a time — the first
            ...
            {roundDrafts.map((draft, i) => (
              <Card key={i}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`desc-${i}`}>Description (optional)</Label>
                    <Input
                      id={`desc-${i}`}
